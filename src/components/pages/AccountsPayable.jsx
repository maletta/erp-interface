...
const AccountsPayable = ({ dispatch, financial }) => {
    ...
    console.log(dispatch, financial);
    const decrementHandler = (e) => {e.stopPropagation(); return dispatch(payAction(50))};
    const incrementHandler = (e) => {e.stopPropagation();  return dispatch(demandAction(50))};
    return (
        <BodyScrollHidden>
...
const mapStateToProps = ({ financial }, props) => {
    return {
        financial,
        ...props
    };
